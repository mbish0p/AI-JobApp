...
export const SAVE_JOB_CATEGORY = 'save_job_category'
export const SAVE_POSITION_NAME = 'save_position_name'
export const SAVE_EXPERIENCE_LVL = 'save_experience_lvl'

export const SAVE_STREET_ADDRESS = 'save_street_address'
export const SAVE_CITY_ADDRESS = 'save_city_address'
